...
function TestimonialCard({ quote, name, role, avatar }) {
  return (
    <div className="w-full max-w-xs flex flex-col gap-4 rounded-[1.75rem] bg-white border border-slate-100 shadow-sm px-6 py-6 transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:shadow-md">
