...
function HeroSection() {
  ...
  return (
    <section className="relative w-full h-[75vh] min-h-[500px] overflow-hidden flex items-end justify-end px-6 sm:px-12 lg:px-20 mt-24 sm:mt-28 pt-12 sm:pt-16 pb-10">
