    ...
    <div className="min-h-screen w-full bg-white flex items-center justify-center px-5">
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <h1 className="text-black text-lg font-bold uppercase tracking-widest">Create Account</h1>
          <p className="text-black/60 text-xs">Join Connect2EdTech today</p>
        </div>
        ...
        <p className="text-center text-[11px] text-black/50">
          ...
          <Link to="/login" className="text-[#f0247a] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
